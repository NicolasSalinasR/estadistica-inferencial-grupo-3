...
Luego de obtener una muestra del csv y transformar todo esto a una matriz de datos en formato largo. Luego de esto podemos notar que la variable de respuesta es dicotómica dado que puede tener el valor de "Apruebo" o "Rechazo". Además, las variables independientes siendo las estrategias son categóricas dado que no representan una cantidad numérica, y no representan un orden jerárquico entre ellos por lo que son categóricas ordinales.
...
prueba
```
Dado que el p-value = 0.8233 es mayor a la significancia de 0.05, se acepta la hipótesis nula de que la proporción de efectividad de las estrategias publicitarias es la misma para todas.
